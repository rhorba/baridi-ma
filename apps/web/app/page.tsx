  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-lg flex-col items-center justify-center gap-4 px-4 text-center">
      ...
      <div className="flex gap-3">
        <a href="/login" className="rounded bg-[var(--color-primary)] px-4 py-2 font-medium text-white">
          Log in
        </a>
        <a href="/register" className="rounded border border-[var(--color-primary)] px-4 py-2 font-medium">
          Register
        </a>
      </div>
    </main>
